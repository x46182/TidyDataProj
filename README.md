...
The following information from each record was used to calculate means and standard deviations for various features:
======================================
...
- 'run_analysis.R' - this script will create a tidy dataset from the UCI HAR Data.  The final dataset will perform the following steps to create the final dataset: 
